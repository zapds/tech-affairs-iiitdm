  ...
  timeline: [
    {
      ...
      description: 'Members participated in several national and global game jam competitions.'
    },
    {
      year: 2025,
      event: 'Indie Game Projects',
      description: 'Students developed independent game prototypes using Unity and Godot.'
    }
  ],

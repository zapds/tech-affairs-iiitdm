...
const clubData = {
  ...
  description: `The Cybersecurity Club at IIITDM Kancheepuram is a student-driven initiative focused on learning and applying concepts in ethical hacking, network security, cryptography, and digital forensics. The club aims to build a foundational understanding of cybersecurity, encouraging students to explore how digital systems are protected and how vulnerabilities are addressed.
Through collaborative learning and practical exploration of cybersecurity tools and techniques, the club fosters an environment of curiosity, technical growth, and responsible digital practices.`,
  core: [
    {
      name: "Dharun Thota",
      role: "Club Lead",
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/rohanshenoy04/",
    },
  ],
  team: [],
  links: {
